...
run(){ python -u tools/make_icon.py --force "$@" || echo "FAIL $2"; }
...
run --name card_beast --label "짐승" --bg white --prompt "full body of a wild boar beast standing, stocky body, bristly dark brown fur, small curved tusks, fierce small eyes, side three-quarter view"
